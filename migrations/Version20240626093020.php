 ...
 */
final class Version20240626093020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, company_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
